...
// 来拒绝响应任何的中断，因此需要我们自己手动调用 interrupt_global_enable(0);
// 来开启中断的响应。
...
// **************************** 外部中断函数 ****************************
// IFX_INTERRUPT(exti_ch0_ch4_isr,
//               EXTI_CH0_CH4_INT_VECTAB_NUM,
//               EXTI_CH0_CH4_INT_PRIO) {
//     interrupt_global_enable(0);             // 开启中断嵌套
...
// IFX_INTERRUPT(exti_ch3_ch7_isr,
//               EXTI_CH3_CH7_INT_VECTAB_NUM,
//               EXTI_CH3_CH7_INT_PRIO) {
//     interrupt_global_enable(0);             // 开启中断嵌套
